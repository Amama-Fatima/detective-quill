...
#   murder, kill, attack, stab, strangle, shoot, threaten, confront, accuse, assault (and other similar)

# TIER 2 — Interpersonal actions (extract if clearly shown in the scene):
#   marry, greet, wait_for, help, trust, suspect, argue, comfort, betray, protect (and other similar)
