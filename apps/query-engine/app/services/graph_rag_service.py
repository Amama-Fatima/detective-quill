...
from app.services.query_classifier_service import QueryClassifier, detect_query_type
...
class GraphRAGService:
    ...
    def generate_cypher(self, question: str, query_type: QueryClassifier) -> str:
        return self._cypher_generation_service.generate_cypher(question, query_type=query_type)
    ...
    async def query(self, question: str) -> QueryResult:
        ...
        cypher = self.generate_cypher(question, query_type=query_type)
        validate_cypher_query(cypher)
