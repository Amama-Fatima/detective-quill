...
// Overload for asChild = true (Slot, generic HTMLElement)
type FilePropsAsChild = {
  value: string;
...
// Overload for asChild = false (button, HTMLButtonElement)
type FilePropsButton = {
  value: string;
  handleSelect?: (id: string) => void;
  isSelectable?: boolean;
  isSelect?: boolean;
...
type FileProps = FilePropsAsChild | FilePropsButton;

const File = React.forwardRef<HTMLElement | HTMLButtonElement, FileProps>(
  (props, ref) => {
    const {
      value,
      className,
