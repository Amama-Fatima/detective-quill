...
export default function KnowledgeGraphClient({ fileId }: KnowledgeGraphClientProps) {
    ...
    return (
      <div className="w-full h-full flex flex-col items-center justify-center bg-background rounded-lg p-8 text-center">
        ...
        <p className="text-xs text-muted-foreground mt-2 max-w-sm">
          Navigate to a file from the workspace or version control and open its graph, or use a URL like{" "}
          <code className="text-foreground/80">/workspace/[project]/knowledge-graph/[fileId]</code>.
        </p>
      </div>
    );
  }
