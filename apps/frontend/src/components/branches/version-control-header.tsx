  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 pb-8 border-b-2 border-primary">
      <div className="flex-1 min-w-0">
        ...
        <button
          onClick={onNewBranch}
          className="cursor-pointer inline-flex rounded-md items-center gap-2 bg-primary text-primary-foreground font-playfair-display text-[15px] tracking-[0.02em] px-7 py-2.5 shadow-[0_4px_20px_oklch(24%_0.022_245/0.22)] hover:-translate-y-0.5 hover:bg-secondary-foreground transition-all duration-200"
        >
