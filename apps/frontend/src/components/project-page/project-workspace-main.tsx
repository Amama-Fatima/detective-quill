...
export default function WorkspaceMainBody({
  ...
  const formattedUpdatedAt = project.updated_at
    ? formatDate(new Date(project.updated_at), "PPP p")
    : "N/A";
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 mx-auto min-h-[80vh] w-full max-w-7xl px-4 py-6 md:px-6">
        <section className="mb-8 rounded-lg border border-border/70 bg-gradient-to-br from-card via-card/90 to-background p-4 shadow-sm sm:p-6 md:p-8">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between lg:gap-8">
            <div className="w-full max-w-3xl space-y-4">
              ...
              <div className="flex flex-wrap items-center gap-4 text-sm text-primary">
                <span className="inline-flex items-center gap-1.5 rounded-lg border  bg-background/80 px-3 py-1.5 hover:-translate-y-0.5 transition-transform">
                  <ClockIcon />
            ...
            <div className="w-full rounded-2xl border border-border/70 bg-background/70 p-4 shadow-sm lg:w-auto lg:min-w-[20rem] lg:max-w-[22rem]">
              <div className="flex items-center gap-3 rounded-lg border border-primary/10 bg-primary/5 p-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="max-w-full break-all font-mono text-sm font-medium md:max-w-[14rem] md:truncate">
                    {currentBranchLabel}
                  </div>
                </div>
              </div>
              ...
              {isOwner && (
                <div className="flex gap-3 pt-4 flex-wrap sm:items-center *:w-fit">
                  <ChangeStateDropDown
