...
export default async function BlueprintPage({ params }: BlueprintPageProps) {
  ...
  return (
    <div className="relative min-h-screen bg-background overflow-hidden">
      <div className="pointer-events-none absolute top-[35%] -right-7.5 w-25 h-25 rounded-full bg-accent opacity-50 z-1 border border-border/60" />
      <div className="pointer-events-none absolute bottom-[20%] -left-5 w-32.5 h-32.5 rounded-full bg-accent opacity-50 z-1 border border-border/60" />
